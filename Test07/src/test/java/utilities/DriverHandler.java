...
public class DriverHandler 
{
	...
	{
		//INFO:  https://stackoverflow.com/questions/7883542/getting-the-computer-name-in-java
		...
		default:   
			...
			if (browserName=="IE")   
			{
				...
				System.setProperty("webdriver.ie.driver",
						"C:\\Users\\"+userName+"\\Testautomatisierung\\Libraries\\IEDriverServer_x64_3.4.0\\IEDriverServer.exe");
			...
			else if(browserName=="Chrome") 
			{
				System.setProperty("webdriver.chrome.driver",
						"C:\\Users\\"+userName+"\\Testautomatisierung\\Libraries\\chromedriver_win32\\chromedriver.exe");
			}
